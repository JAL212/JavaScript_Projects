...
function placeXOrO(squareNumber) {
    ...
    function computersTurn() {
        ...
        let success = false;
        //This variable stores a random numbers 0-8.
        let pickASquare;
...
//This function parses the selectedSquares array to searcj for win conditions.
...
function checkWinConditions() {
    ...
    //This function check if an array includes 3 string. It is used to check for 
    //each win condition.
...
//This function makes our body elemeny temporariyl unclickable.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            //This is neccessary for for the 6, 4, 2 win conditions.
